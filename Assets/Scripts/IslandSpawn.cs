...
public class IslandSpawn : MonoBehaviour
{
    ...
    IEnumerator spawnWait()
    {
        ...
        while(true)
        {
            ...
            GameObject go = Instantiate(Projectileprefab[random], spawnPos, Projectileprefab[random].transform.rotation) as GameObject; //this will spawn the actual object which will be within the randomly generated position 
            go.AddComponent<Island_Movement>();
            go.AddComponent<Rigidbody>();
            go.gameObject.tag = "Island";
